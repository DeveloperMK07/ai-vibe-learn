    ...
    return (
        <main className="min-lg:w-3/4">
            ...
            <section>
                ...
                <AccordionItem value="rencent">
                    <AccordionTrigger className="text-2xl font-bold"> Rencent Sessions</AccordionTrigger>
                    <AccordionContent>
                        <CompanionsList title="Rencent Sessions" companions={sessionHistory}/>
                    </AccordionContent>
                </AccordionItem>
